...
class TestNumberLine:
    ...
    def test_add_point(self):
        ...
        number_line.__add_point(0)

        number_line.__add_point(1)

        number_line.__add_point(2)
    ...
    def test_add_point_outside_bounds(self):
        ...
        with pytest.raises(ValueError):
            ...
            number_line.__add_point(3)

    def test_generate_random_points(self):

        number_line = NumberLine(0, 2, 1)

        random_points = number_line.__generate_random_points(3)
    ...
    def test_visualize(self):
        ...
        number_line.__add_point(0.5)

        number_line.__add_point(1.5)
    ...
    def test_visualize_random(self):
        ...
        random_points = number_line.__generate_random_points(10)

        for point in random_points:
            number_line.__add_point(point)
