...
A cursory examination of n = 100 held true the limit hypothesis with a 100,000 iteration-per-step test on a 
0.001 width interval step showing P = 1.985 on a segment spanning 0 to 2. From this,a 0.985 distance-from-center
